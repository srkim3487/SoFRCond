#' Example Dataset: binary_data
#' 
#' A simulated example dataset for illustrating binary conditional model with functional covariate
#' 
...
#' \item{\code{y}:}{A numeric vector of binary responses (length 900), on 30*30 regular lattice.}
